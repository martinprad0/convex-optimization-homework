...
\usepackage{tikz, subfig, subcaption, graphicx, float, wrapfig, multicol, graphicx} % tikz, graphics and positioning.
...
%Words
\def\Sym{\ensuremath{\mbox{Sym}}}
\def\tr{\ensuremath{\mbox{tr}}}
\def\dom{\ensuremath{\mbox{dom}}}
\def\rank{\ensuremath{\mbox{rank}}}
\def\diag{\ensuremath{\mbox{diag}}}
\def\co{\ensuremath{\mbox{co}}}
\def\dist{\ensuremath{\mbox{dist}}}
...
% Title Info
\title{Convex Optimization: Homework 3} 
\author{Martín Prado}
